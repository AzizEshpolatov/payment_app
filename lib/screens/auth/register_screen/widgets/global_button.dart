...
class RegisterGlobalButton extends StatefulWidget {
  ...
  @override
  State<RegisterGlobalButton> createState() => _GlobalButtonState();
}

class _GlobalButtonState extends State<RegisterGlobalButton> {
  @override
